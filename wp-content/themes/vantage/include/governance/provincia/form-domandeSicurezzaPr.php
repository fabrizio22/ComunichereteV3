<div id="containerDomandeSicurezzaPr" class="containerDomandeSicurezzaPr">
<br/>
...
<label class="labelBusinessTitoli">Domande di Sicurezza</label><br />
	<div id="domanda1" class="domanda1">
		  <select class="selectGenerica" id="selectDomanda" name="selectDomanda1-1">
	...
	<input type="text" id="risposta" class="risposta" name="risposta1-1" placeholder="inserisci la tua prima Domanda" value""> <img name="info" id="info" class="info">
    <input type="hidden" name="risposta1H" value="Risposta Ente 1">
	</div><br/>
	<div id="domanda2" class="domanda2 domanda">
		  <select class="selectGenerica" id="selectDomanda" name="selectDomanda1-2">
	    ...
	    <input type="text" id="risposta" class="risposta" name="risposta1-2" placeholder="inserisci la tua seconda Domanda" value"">
	...
	<div id="domanda3" class="domanda3 domanda">
		  <select class="selectGenerica" id="selectDomanda" name="selectDomanda1-3">
        ...
        <input type="text" id="risposta" class="risposta" name="risposta1-3" placeholder="inserisci la tua terza Domanda" value"">
        <input type="hidden" name="risposta3H" value="Risposta Ente 3">
    <img name="info" id="info" class="info">
	</div>
</div>

<div class="tooltip" id="pop-up" style="position: absolute; top: -62px; left: 69px; display: none;">
