<div id="containerpoliziaMunicipalePr" class="containerpoliziaMunicipalePr">
...
<select class="selectCerca" id="settoriMunicipale" name="settoriMunicipale">
    <option selected="selected" value="1">Seleziona un Nucleo</option>
    <option value="Contenzioso Permessi">Contenzioso Permessi</option>
