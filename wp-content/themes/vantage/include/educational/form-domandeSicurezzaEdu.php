<div id="containerDomandeSicurezzaEdu" class="containerDomandeSicurezzaEdu">
<br/>
<label class="titoloGruppoComuni">Password e Sicurezza</label><br /><hr class="gruppoComuneRegioneHr">
	<div id="ContainerPassword" class="ContainerPassword"> 
		<input type="password" name="password" id="password" class="password"  placeholder="inserisci un Password" ><br/>
		<input type="password" name="passwordConf" id="confPassword" class="confPassword"  placeholder="conferma password" >
	</div>
