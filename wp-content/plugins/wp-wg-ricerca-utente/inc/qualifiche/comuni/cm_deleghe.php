...
?>
    <a href="#" id="selectComplessaFiltro" class="selectComplessa"><div class="divLinkSelectEvoluta" id="divLinkSelectEvoluta" nome="divLinkSelectEvoluta">Deleghe</div>
        <div class="contentFrecciaSelectFiltri contentFrecciaSelectDeleghe" id="contentFrecciaSelectFiltri" nome="contentFrecciaSelectFiltri"><img src="http://localhost/ComunichereteV3/wp-content/plugins/wp-wg-ricerca-utente/img/freccia.png" class="freccia"></div>
    </a>

<div class="cm_deleghe" id="cm_deleghe" name="cm_deleghe">
    <div id="cm_apriDelegheGov" class="cm_apriDelegheGov">
        <ol class="facet-valuesDeleghe">
